  ...
  const articles = [
    {
      ...
      excerpt: 'Learn the best practices for building scalable React applications with TypeScript, including hooks, context, and modern patterns.',
      category: 'React',
      author: 'Antono',
      date: 'August 5, 2024',
    ...
    {
      id: 2,
      title: 'Tailwind CSS: Rapid UI Development Guide',
      excerpt: 'Master Tailwind CSS utility classes for building beautiful, responsive interfaces in record time.',
      category: 'React',
      author: 'Antono',
      date: 'July 28, 2024',
      readTime: '8 min read',
    ...
    },
    {
      ...
      excerpt: 'Comprehensive guide to building production-ready REST APIs with Node.js, Express, and proper error handling.',
      category: 'Node.js',
      author: 'Antono',
      date: 'July 15, 2024',
    ...
    },
    {
      ...
      excerpt: 'Essential Git workflows, branching strategies, and collaboration tips for effective team development.',
      category: 'DevOps',
      author: 'Antono',
      date: 'July 1, 2024',
      readTime: '7 min read',
    ...
    {
      id: 5,
      title: '5 Lessons from My First Year as a Developer',
      excerpt: 'Key insights and lessons from my journey as a software developer, including career growth and technical skills.',
      category: 'Career',
      author: 'Antono',
      date: 'June 20, 2024',
      readTime: '6 min read',
    ...
    {
      id: 6,
      title: 'Deploying Apps with GitHub Actions CI/CD',
      excerpt: 'Complete tutorial on setting up continuous integration and deployment pipelines using GitHub Actions.',
      category: 'DevOps',
      author: 'Antono',
      date: 'June 10, 2024',
